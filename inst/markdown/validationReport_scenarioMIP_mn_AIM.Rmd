---
title: "AIM 3.0 Scenario MIP Validation Report"
...
regs.short <- c(
  "Rest of East and South East Asia" = "Rest E-Asia",
  "New Zealand and Australia" = "NZA",
  "Rest of Latin America" = "Rest LAM"
)
```
...
# Scenario Data
if (interactive()) setwd(rprojroot::find_rstudio_root_file())
...
and reformulated to be machine-readable bounds, with the exact values listed in a [**validationConfig**](https://pik-piam.github.io/piamValidation/articles/configs/validationConfig_ScenarioMIP_AIM.html) file. For further information on the validation tool, consult the [ documentation](https://pik-piam.r-universe.dev/articles/piamValidation/validateScenarios.html) or the [accompanying paper](https://gmd.copernicus.org/articles/18/9897/2025/).
