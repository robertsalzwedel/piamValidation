---
title: "REMIND-MAgPIE35-411 Scenario MIP Validation Report"
...
# Data Preparation
config <- paste0("scenarioMIP_", "REMIND-MAgPIE35-410", "_", config_date)
...
hist <- readRDS(paste0("data/historical_all_", historical_date, ".rds")) %>%
  filter(grepl("REMIND-MAgPIE35-410", region) | region == "World") 
...
and reformulated to be machine-readable bounds, with the exact values listed in a [**validationConfig**](https://pik-piam.github.io/piamValidation/articles/configs/validationConfig_ScenarioMIP_REMIND.html) file. For further information on the validation tool, consult the [ documentation](https://pik-piam.r-universe.dev/articles/piamValidation/validateScenarios.html) or the [accompanying paper](https://gmd.copernicus.org/articles/18/9897/2025/).
