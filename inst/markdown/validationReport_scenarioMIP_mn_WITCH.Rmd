...
and reformulated to be machine-readable bounds, with the exact values listed in a [**validationConfig**](https://pik-piam.github.io/piamValidation/articles/configs/validationConfig_ScenarioMIP_WITCH.html) file. For further information on the validation tool, consult the [ documentation](https://pik-piam.r-universe.dev/articles/piamValidation/validateScenarios.html) or the [accompanying paper](https://gmd.copernicus.org/articles/18/9897/2025/).
